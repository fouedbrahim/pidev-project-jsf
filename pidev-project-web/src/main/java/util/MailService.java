...
public class MailService {
    ...
    private static final String USER = "TTMA ESPRIT";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "22207556"; // Must be valid password for smit0012
    private static final String FROM = "ttma.esprit@gmail.com";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}